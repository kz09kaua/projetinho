...
const DashboardPaciente = () => {
  const [fila, setFila] = useState({ senha: 'A-142', posicao: 4, tempo: '12 min' });
  ...
  return (
    <div>
      <div className="flex justify-between items-center mb-8 flex-wrap gap-4">
        ...
        <div className="bg-white p-3 rounded-2xl shadow-sm flex items-center gap-4 border">
          <div className="text-right">
            <p className="text-[10px] font-bold text-gray-400 uppercase">Check-in via</p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 bg-white rounded-3xl p-6 shadow-sm border relative overflow-hidden">
          <div className="flex justify-between items-start">
            <span className="bg-green-100 text-green-800 px-3 py-1 rounded-full text-xs font-bold flex items-center gap-2">
              <span className="w-2 h-2 bg-green-500 rounded-full animate-pulse"></span> Chamada Ativa
            </span>
            <div className="text-right">
          ...
          <div className="text-center my-8">
            ...
            <span className="text-6xl font-black text-blue-700">{fila.posicao}</span>
            <p className="text-gray-500">da fila de espera</p>
            <p className="text-sm text-gray-400 mt-2">Senha: {fila.senha}</p>
          </div>
          <div className="grid grid-cols-2 gap-4 pt-4 border-t">
            <div className="bg-gray-50 p-4 rounded-2xl">
              <p className="text-xs font-bold text-gray-400 uppercase">Senha Atual</p>
        ...
        <div className="space-y-6">
          <div className="bg-gray-800 text-white rounded-3xl p-6">
            ...
            <div className="space-y-3">
              <div className="flex justify-between items-center p-3 bg-white/10 rounded-xl">
                <div><p className="text-xs text-gray-300">Clínica</p><p className="font-bold">A-45</p></div>
                <span className="text-green-400 text-xs">Chamado</span>
              </div>
              <div className="flex justify-between items-center p-3 bg-white/10 rounded-xl">
                <div><p className="text-xs text-gray-300">Pediatria</p><p className="font-bold">P-12</p></div>
          ...
          <div className="bg-blue-700 text-white p-6 rounded-3xl flex justify-between items-center">
            <div><p className="text-sm opacity-80">Precisa de ajuda?</p><p className="font-bold">Falar com recepção</p></div>
